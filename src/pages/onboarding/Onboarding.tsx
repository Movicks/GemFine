  ...
  return (
    <section className="relative flex flex-col items-center justify-center h-screen bg-redGradient">
      <div className="Row-container absolute inset-0 flex flex-col justify-center items-center bg-black bg-opacity-10 backdrop-blur-md z-50 gap-9 w-full md:max-w-[30rem] lg:max-w-[40rem] lg:w-full shadow-custom px-3 rounded-lg">
        ...
        <Link
          to="/register"
          className="rounded-full shadow-custom text-center text-xl px-3 py-2 text-white flex items-center justify-between w-full max-w-[17rem] bg-black"
        >
        ...
        <div className="Socials mt-5 flex items-center px-3 justify-between w-full max-w-[17rem]">
          <a
            ...
            className="border-2 border-gray-200 p-1 md:p-2 rounded-full bg-black"
          >
            <FaFacebookF className="text-2xl text-white rounded-full" />
          </a>
          <a
            href="https://twitter.com"
            className="border-2 border-gray-200 p-1 md:p-2 rounded-full bg-black"
          >
            <BsTwitterX className="text-2xl text-white rounded-full" />
          </a>
          <a
            href="https://instagram.com"
            className="border-2 border-gray-200 p-1 md:p-2 rounded-full bg-black"
          >
            <IoLogoInstagram className="text-2xl text-white rounded-full" />
          </a>
          <a
            href="https://tiktok.com"
            className="border-2 border-gray-200 p-1 md:p-2 rounded-full bg-black"
          >
            <IoLogoTiktok className="text-2xl text-white rounded-full" />
          </a>
        </div>
      </div>
